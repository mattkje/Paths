...
public class DataBase {
    ...
    public String getActivePlayerPath() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("Data/currentPlayerFile.cfg"))) {
            ...
            if (!new File(activePlayer).exists()){
                ...
                activePlayer = "Data/PlayerData/Players/player1.txt";
            }
        } catch (IOException e) {
    ...
    public void writeFile(Player player) {
        ...
        if (player.getImage() != null) {
            ...
            while (new File("Data/PlayerData/Images/pp" + i + ".png").exists()){
                i++;
            }
        ...
        while (new File("Data/PlayerData/Players/player"+i+".txt").exists()){
            i++;
        }
    ...
    public void deletePlayer(int i){
        File playerFile = new File("Data/PlayerData/Players/player"+i+".txt");
        File playerImageFile = new File("Data/PlayerData/Images/pp"+i+".png");
        if (playerFile.delete() && playerImageFile.delete()) {
            System.out.println("Deleted the file player");
        } else {
            System.out.println("Failed to delete the player.");
        }
    }
